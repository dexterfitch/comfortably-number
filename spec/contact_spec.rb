...
describe('Contact') do
  ...
  describe('#name') do
    it('returns a contact\'s name') do
      test_contact = Contact.new('Hester Stanhope')
  ...
  describe('#id') do
    it('returns the id of a contact') do
      test_contact = Contact.new('Hypatia')
  ...
  describe('#save') do
    it('adds a contact to the list of saved contacts') do
      test_contact = Contact.new('Ching Shih')
      test_contact.save()
  ...
  describe('#add_number') do
    it('adds a new number to the list of stored numbers') do
      test_contact = Contact.new('Katie Sandwina')
      test_number = Phone.new('Home', 5558080)
  ...
  describe('.clear') do
    it('returns an empty list after contacts have been saved and then cleared') do
      Contact.new('Julie d\'Aubigny').save()
      Contact.clear()
      expect(Contact.all()).to(eq([]))
    end
  end
  ...
  describe('.find') do
    it('returns a contact by a given id number') do
      test_contact = Contact.new('Shajar al-Durr')
      test_contact.save()
      test_contact2 = Contact.new('Osh-Tisch')
      test_contact2.save()

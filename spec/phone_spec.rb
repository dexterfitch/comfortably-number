...
describe('Phone') do
  ...
  describe('#type') do
    it('returns the type') do
      test_number = Phone.new('Ghosts',5552368)
  ...
  describe('#id') do
    it('returns the id of a number') do
      test_number = Phone.new('Plow',5553226)
  ...
  describe('#save') do
    it('adds a contact to the list of saved contacts') do
      test_number = Phone.new('Wrong',6060842)
      test_number.save()
  ...
  describe('.find') do
    it('returns a contact by a given id number') do
      test_number = Phone.new('Mobile', 5556162)
      test_number.save()
      test_number2 = Phone.new('Wall',8675309)
      test_number2.save()
